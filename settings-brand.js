...
(function(){
  ...
  var ICON = {
    ...
    chev:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 9.00005C18 9.00005 13.5811 15 12 15C10.4188 15 6 9 6 9"/></svg>',
    ...
    /* MIT stroke. Ohne fill="none" stroke="currentColor" zeichnet der Browser zwei Linien ohne
       Strichfarbe -- das X war da, hatte seine 13x13 und war schlicht unsichtbar. Jedes andere
       Icon dieser Datei hat die Attribute, dieses eine nicht. */
    ...
    logout: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19.996 12H9.99603"/><path d="M13.9724 6C13.9259 4.90656 13.7875 4.20981 13.3761 3.67372C13.2165 3.46572 13.0303 3.27954 12.8223 3.11994C12.0144 2.5 10.8416 2.5 8.49603 2.5C6.15046 2.5 4.97767 2.5 4.16975 3.11994C3.96175 3.27954 3.77557 3.46572 3.61597 3.67372C2.99603 4.48164 2.99603 5.65442 2.99603 8L2.99603 16C2.99603 18.3456 2.99603 19.5184 3.61597 20.3263C3.77557 20.5343 3.96175 20.7205 4.16975 20.8801C4.97767 21.5 6.15046 21.5 8.49603 21.5C10.8416 21.5 12.0144 21.5 12.8223 20.8801C13.0303 20.7205 13.2165 20.5343 13.3761 20.3263C13.7875 19.7902 13.9259 19.0934 13.9724 18"/><path d="M17.4961 15.5C17.4961 15.5 20.996 12.9223 20.996 12C20.996 11.0777 17.496 8.5 17.496 8.5"/></svg>',
    ...
    close:  '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6L6.00081 17.9992M17.9992 18L6 6.00085"/></svg>',
    check:  '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 13.2592L7.58583 15.9568C8.2525 16.6523 8.58583 17 9.00004 17C9.41425 17 9.74759 16.6523 10.4143 15.9568L19 7"/></svg>'
  };
    ...
    function ddHtml(kind, placeholder, searchLabel, title, icon){
      return '<div class="up-ddwrap usb-dd" data-dd="' + kind + '">' +
        '<button class="up-ddtrigger" type="button" data-dd-btn aria-haspopup="menu" aria-expanded="false">' +
          ...
          '<svg class="up-ddtrigger-chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 9.00005C18 9.00005 13.5811 15 12 15C10.4188 15 6 9 6 9"/></svg>' +
        '</button>' +
