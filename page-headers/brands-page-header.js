...
(function(){
  ...
  /* Lucide "square-stack" / "compass" -- Tracked ist derselbe Stapel wie der Brands-Punkt in der
     Navigation, Discover bleibt der Kompass (etwas Neues finden). Vorher stand hier "copy", also
     dasselbe Zeichen wie der Kopieren-Knopf in den Tabellen: zwei Bedeutungen, ein Bild. */
  var PAGES = [
    { value: "tracked", label: "Tracked",
      icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2"/><path d="M10 16c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2"/><rect width="8" height="8" x="14" y="14" rx="2"/></svg>' },
