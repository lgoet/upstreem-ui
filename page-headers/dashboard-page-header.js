  ...
  function buildController(root){
    ...
    (function markupNachziehen(){
      ...
      if (topright && !root.querySelector(".dph-mode")){
        ...
        /* POWER ZUERST (15.09. angefordert). Die BESCHRIFTUNGEN heissen seit dem 17.09.
           "Agentic" und "Analytic" -- NUR die Beschriftung: die WERTE bleiben "power" und
           "standard". An ihnen haengen der
        ...
        seg.innerHTML = ["power", "standard"].map(function(v){
          var lbl = v === "power" ? "Agentic" : "Analytic";
