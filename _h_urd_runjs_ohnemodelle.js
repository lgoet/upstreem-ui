...
(function(){
  ...
  (function los(){
    if (typeof window.setResponseDetail === "function") {
      /* typeof MODELLE und nicht MODELLE selbst: wer den Block oben loescht, hat die Variable dann
         nicht mehr, und jede andere Pruefung wuerde hier mit "MODELLE is not defined" werfen und
         den ganzen Schritt mitreissen -- genau das ist passiert. typeof ist die einzige Form, die
         eine nicht deklarierte Variable verkraftet. */
