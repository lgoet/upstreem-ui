  ...
  function installUstTopics(){
    ...
    window.__uptUstTopics = (function(){
      ...
      style.textContent = [
        ...
        '.ust-cell .ust-more{height:28px;padding:0 10px;border-radius:8px;display:inline-flex;align-items:center;flex:0 0 auto;border:0;background:#f4f2f4;color:var(--ust-more-color,#5f646d);font-size:12px;line-height:1;font-weight:600;white-space:nowrap;cursor:pointer;user-select:none;}',
  ...
  function makeController(root){
    ...
    function persist(){
      ...
      /* Die Werkzeugleiste haengt hier mit dran, weil ein Filter sich ohne render() aendern
         ...
         Der Wachposten ist noetig: persist() laeuft auch, bevor toolGroup zugewiesen ist. */
    ...
    /* EIN Zeichen fuer beide Umschalter (den im Kopf der Gruppenliste und den in der Werkzeugleiste):
       ...
       Pixel breit, wie in der Hauptleiste.
    ...
    function render(){
      ...
      /* Nach renderStatusTabs, weil das die Statusgruppe neu einsortiert und die Gruppe die
         Nachzuegler danach wieder einsammeln muss. sync() haengt zusaetzlich daran, dass sich ein
         Filter auch OHNE Zeigerbewegung aendern kann -- ueber die Suche, ueber einen Reset, ueber
    ...
    /* Die einklappbare Werkzeugleiste kommt aus core (UC.makeToolGroup) -- hier steht nur noch, was
       ...
       sie brauchte, statt als sechste Kopie zu enden.
       ...
       dass sie an sind. Die Gruppierung war zuerst drin; sie liegt im localStorage, also haette
