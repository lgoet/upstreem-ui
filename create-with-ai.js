...
(function(){
  ...
  var X_SVG      = '<svg viewBox="0 0 24 24" ' + SV + ' stroke-width="1.9"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';
  var X_SMALL    = '<svg viewBox="0 0 24 24" ' + SV + ' stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';
  var CHECK_SVG  = '<svg viewBox="0 0 24 24" ' + SV + ' stroke-width="3"><polyline points="20 6 9 17 4 12"></polyline></svg>';
  var CHECK_BOLD = '<svg viewBox="0 0 24 24" ' + SV + ' stroke-width="3.2"><polyline points="20 6 9 17 4 12"></polyline></svg>';
  ...
  var CHEV_SVG   = '<svg viewBox="0 0 24 24" ' + SV + ' stroke-width="1.9"><polyline points="9 18 15 12 9 6"></polyline></svg>';
  var BACK_SVG   = '<svg viewBox="0 0 24 24" ' + SV + ' stroke-width="1.9"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>';
  ...
  var GLOBE_SVG  = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="12" cy="12" r="9"></circle><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18"></path></svg>';
  ...
  var NEWDOC_SVG = '<svg viewBox="0 0 24 24" ' + SV + ' stroke-width="1.8"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>';
