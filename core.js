...
(function(){
  ...
  function makeLine(cfg){
    ...
    function themeColors(){
      return isDark()
        ? { text:"#e0e0e0", muted:"#a0a0a0", border:"#34343a", bg:"#1c1c1f", grid:"rgba(255,255,255,0.09)" }
        ...
        : { text:"#1f1f1b", muted:"#6b6f78", border:"#e4e2e4", bg:"#ffffff", grid:"rgba(0,0,0,0.09)" };
    }
  ...
  var ICON_PATHS = {
    ...
    /* newspaper -- das Zeichen des Daily Briefing (17.09. angefordert, loest chartSpline dort
       ab). Wortgleich aus dem Lucide-Bestand. */
